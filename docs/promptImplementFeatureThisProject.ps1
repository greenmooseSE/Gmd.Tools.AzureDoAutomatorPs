...
$projectStoryRulesContent = hReadInclude 'createStoryRules_AutomatorPs.md'
...
*Generated by ``docs\promptImplementFeatureThisProject.ps1`` — $(Get-Date -Format 'yyyy-MM-dd HH:mm')*
"@
