...
<#
.SYNOPSIS
Verification tests for all AC Scenarios in story 1579: UpsertAzDoEpic functionality
...
Write-Host "AC SCENARIO VERIFICATION - Story 1579: UpsertAzDoEpic" -ForegroundColor Cyan
Write-Host "═══════════════════════════════════════════════════════════════" -ForegroundColor Cyan
